      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-3 gap-6 mt-16">
          <div className="bg-card rounded-xl p-6 border border-border text-center hover:border-wire-focus transition-medium">
            ...
            <p className="text-wire-text-muted">Cataloguez vos variétés avec toutes les informations essentielles</p>
          </div>
          ...
          <div className="bg-card rounded-xl p-6 border border-border text-center hover:border-wire-focus transition-medium">
            ...
            <p className="text-wire-text-muted">Suivez votre stock et l'origine de vos sachets de graines</p>
          </div>
          ...
          <div className="bg-card rounded-xl p-6 border border-border text-center hover:border-wire-focus transition-medium">
            ...
            <p className="text-wire-text-muted">Planifiez et suivez vos sessions de semis tout au long de l'année</p>
          </div>
        </div>
      </div>
