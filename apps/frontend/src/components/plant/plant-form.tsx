...
export function PlantForm({
   ...
   const {
      ...
      resolver: zodResolver(createPlantSchema) as Resolver<CreatePlantInput>,
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
         ...
         <section className="space-y-4">
            ...
            <p className="text-sm text-wire-text-light italic">
               Les périodes de semis (semaines 1-52) seront gérées via un composant calendrier dans une prochaine
               session.
            </p>
         </section>
